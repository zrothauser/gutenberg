...
describe( 'shortcode', () => {
	...
	describe( 'replace', () => {
		...
		it( 'should replace shortcode with a number', () => {
			...
			const result2 = replace( 'foo', 'hello [foo bar=bar baz="baz" qux]delete me[/foo] world', () => 4 );
		...
		it( 'should replace shortcode with an empty string', () => {
			...
			const result2 = replace( 'foo', 'hello [foo bar=bar baz="baz" qux]delete me[/foo] world', () => '' );
