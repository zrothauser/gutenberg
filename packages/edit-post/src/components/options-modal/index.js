...
export function OptionsModal( { isModalActive, isViewable, closeModal, toggleIconLabels } ) {
	if ( ! isModalActive ) {
		return null;
	}
...
export default compose(
	...
	withDispatch( ( dispatch ) => {
		return {
			...
			toggleIconLabels: () => dispatch( 'core/edit-post' ).toggleFeature( 'showIconLabels' ),
		};
	} )
)( OptionsModal );
